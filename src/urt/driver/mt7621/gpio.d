...
static immutable Group[12] groups = [
    ...
    Group(34, 40, 11, 1, true),     // spi: the boot NOR
...
uint bank(uint reg, uint pin) => gpio_base + reg + (pin / 32) * 4;
uint bit(uint pin) => 1u << (pin % 32);
...
unittest
{
    ...
    import urt.driver.gpio : GpioLine, gpio_interrupt_close, gpio_interrupt_open, gpio_interrupt_set_callback;

// RP2350 newlib/picolibc syscall stubs
//
// Minimal stubs to satisfy picolibc's syscall requirements.
// Same pattern as BL618 -- most are no-ops for baremetal.
module sys.rp2350.syscalls;
...
{
    import sys.rp2350.uart : uart0_hw_puts;
    if (fd == 1 || fd == 2)
...
// These satisfy link-time references from the D runtime's exception
// personality code which assumes DWARF on all platforms.

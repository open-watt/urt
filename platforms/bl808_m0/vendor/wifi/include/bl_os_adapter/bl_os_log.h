...
#define bl_os_log_debug(M, ...) \
    bl_os_log_printf(LOG_LEVEL_DEBUG, NULL, __FILE__, __LINE__, M, ##__VA_ARGS__);

#define bl_os_log_info(M, ...) \
    bl_os_log_printf(LOG_LEVEL_INFO, NULL, __FILE__, __LINE__, M, ##__VA_ARGS__);

#define bl_os_log_warn(M, ...) \
    bl_os_log_printf(LOG_LEVEL_WARN, NULL, __FILE__, __LINE__, M, ##__VA_ARGS__);

#define bl_os_log_error(M, ...) \
    bl_os_log_printf(LOG_LEVEL_ERROR, NULL, __FILE__, __LINE__, M, ##__VA_ARGS__);
